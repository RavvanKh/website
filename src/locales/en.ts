export default {
  ...
  graduates: "Graduates",
  graduatesTitle: "Top Companies Hiring Our Graduates",
  graduatesDescription:
    "Equipped with real-world skills, our alumni thrive in diverse roles across the information technology sector.",
  ...
  reflectOurValues: "reflect our values.",
  graduateDescription:
    "Our graduates succeed thanks to energetic instructors who share real-world experience and practical skills, preparing them to excel from day one.",
  ...
  technicalKnowledgeLevel: "Technical Knowledge Level",
  englishProficiencyLevel: "English Proficiency Level",
  paymentResponsibility: "Payment Responsibility",
  inClass: "In Class",
  hybrid: "Hybrid",
  selfPayment: "By Self",
  companyPayment: "By Company",
  universityOrEducation: "University or Education",
  currentWorkplace: "Current Workplace",
  selectLearningPreference: "Select Learning Preference",
  selectTechnicalKnowledgeLevel: "Select Technical Knowledge Level",
  ...
  selectPreviousTrainings: "Select Previous Trainings",
  ...
  copy: "Copy",
  clipboardSuccess: "Url was copied to clipboard successfully",
  clipboardError: "An error occured when copied to clipboard",
  trainingIsRequired: "Training is required",
  ...
  hasBeenAwardedThe: "has been awarded the",
  diploma: "DIPLOMA",
  forSuccessfullyCompletingTheRequirementsOf: "for successfully completing the requirements of",
} as const;
